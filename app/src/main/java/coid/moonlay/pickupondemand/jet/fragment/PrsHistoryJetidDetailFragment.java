...
public class PrsHistoryJetidDetailFragment extends TaskDetailFragment {
    private final static String TASK_ARGS_PARAM = "TaskParam";
    private Task mTask;

    public PrsHistoryJetidDetailFragment()
    {
    }

    public static PrsHistoryJetidDetailFragment newInstance(Task task)
    {
        PrsHistoryJetidDetailFragment fragment = new PrsHistoryJetidDetailFragment();
