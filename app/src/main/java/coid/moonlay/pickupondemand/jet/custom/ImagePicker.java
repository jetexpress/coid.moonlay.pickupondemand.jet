...
public class ImagePicker {
    ...
    public static void pickImage(Activity activity) {
        String chooserTitle = activity.getString(R.string.choose_image);
    ...
    public static void setMinQuality(int width, int height) {
        ImagePicker.minWidthQuality = width;
        ImagePicker.minHeightQuality = height;
    }
}
