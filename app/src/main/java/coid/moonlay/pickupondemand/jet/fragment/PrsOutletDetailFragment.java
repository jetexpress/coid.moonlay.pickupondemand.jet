...
/**
 * Created by jordan.leonardi on 3/2/2018.
 */

public class PrsOutletDetailFragment extends TaskDetailFragment {

    private final static String TASK_ARGS_PARAM = "TaskParam";
    private Task mTask;

    public PrsOutletDetailFragment()
    {
    }

    public static PrsOutletDetailFragment newInstance(Task task)
    {
        PrsOutletDetailFragment fragment = new PrsOutletDetailFragment();
