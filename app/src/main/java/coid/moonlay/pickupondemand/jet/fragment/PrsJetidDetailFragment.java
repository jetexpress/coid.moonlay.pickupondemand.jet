...
public class PrsJetidDetailFragment extends TaskDetailFragment {
    private final static String TASK_ARGS_PARAM = "TaskParam";
    private Task mTask;

    public PrsJetidDetailFragment()
    {
    }

    public static PrsJetidDetailFragment newInstance(Task task)
    {
        PrsJetidDetailFragment fragment = new PrsJetidDetailFragment();
